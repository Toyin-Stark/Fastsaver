...
import kotlinx.android.synthetic.main.story_book.view.*
import ng.canon.fastsaver.Commons.Saveit
import ng.canon.fastsaver.Commons.UserAdapter
import ng.canon.fastsaver.Commons.UserModel
...
class StoryBook : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
     ...
     val v = inflater.inflate(R.layout.story_book, container, false)

        swipes = v.swipes
        recyclerview = v.recyclerview
        adView = AdView(activity, getString(R.string.bannerID), AdSize.BANNER_HEIGHT_50)
        v.adContainer.addView(adView)
        adView!!.loadAd();
